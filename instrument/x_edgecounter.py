...
class FreqTask():
    def __init__(self, channel, sampling_time = 0.01, count = False ):
        ...
        #self.error(dll.DAQmxConnectTerms( "/Dev1/80MHzTimebase", "/Dev1/Ctr1Source",
        #            DAQmx_Val_DoNotInvertPolarity))
        #self.error(dll.DAQmxDisconnectTerms( "/Dev1/PFI15", "/Dev1/Ctr0Aux"))
        ...
        #self.error(dll.DAQmxCreateCICountEdgesChan(self.handle, "/Dev1/Ctr1","", DAQmx_Val_Rising, 0, DAQmx_Val_CountUp))
        ...
        #self.error(dll.DAQmxCfgSampClkTiming(self.handle, "/Dev1/Ctr0Source",
#                                             c_double(2e6), DAQmx_Val_Rising, DAQmx_Val_FiniteSamps, c_uint64(1)))

        #self.error(dll.DAQmxCfgDigEdgeStartTrig(self.handle, "/Dev1/PFI37", DAQmx_Val_Rising))
        #self.error(dll.DAQmxSetArmStartTrigType(self.handle, DAQmx_Val_DigEdge))
        #self.error(dll.DAQmxSetDigEdgeArmStartTrigSrc(self.handle,  "/Dev1/Ctr1Source"))
        #self.error(dll.DAQmxSetDigEdgeArmStartTrigEdge(self.handle, DAQmx_Val_Rising))
        #self.error(dll.DAQmxSetStartTrigRetriggerable(self.handle, True))
        #self.error(dll.DAQmxCfgDigEdgeRefTrig(self.handle, "/Dev1/PFI38", DAQmx_Val_Rising, c_int(0)))
